...
//altsyncram ADDRESS_ACLR_A="NONE" CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Cyclone IV E" ENABLE_RUNTIME_MOD="NO" INIT_FILE="rom1.mif" NUMWORDS_A=8 OPERATION_MODE="ROM" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="UNREGISTERED" WIDTH_A=1 WIDTH_BYTEENA_A=1 WIDTHAD_A=3 address_a clock0 q_a
...
endmodule //rom_lab04_altsyncram
//VALID FILE
...
`endif
	...
	rom_lab04_altsyncram	rom_lab04_altsyncram_component (
				.address_a (address),
				.clock0 (clock),
				.q_a (sub_wire0));
